...
import { mergeSearchResults, normalizeSearchResult, sortSearchResultsByNewest } from "./search-results.mjs";

export { sortSearchResultsByNewest };
...
export async function executeSearchPipeline(options) {
  ...
  assertActive(isCanceled);
  const merged = mergeSearchResults(sourceRuns);
  return {
